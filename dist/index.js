...
function Client({ token, host = 'app.terraform.io', version = '/api/v2' }) {
...
const publish_1 = __webpack_require__(6123);
const terraform = __importStar(__webpack_require__(6744));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const module = yield publish_1.publish({
...
function lookupVCSTokenID(tf, organization, vcsName) {
    return __awaiter(this, void 0, void 0, function* () {
        const oauthClients = yield tf({
            url: `/organizations/${organization}/oauth-clients`,
            method: 'get'
        });
        const matchingClients = oauthClients.data.data.filter((client) => client.attributes.name === vcsName);
        if (!matchingClients.length) {
            throw new Error(`VCS client "${vcsName}" not found`);
        }
        const oauthTokens = yield tf({
...
function newModuleFromResponse({ id, attributes: { name, namespace, provider, ['vcs-repo']: { identifier, ['display-identifier']: display } } }) {
    return {
        id,
        name,
        namespace,
